        ...
        <Box className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch">
          ...
          <Box className="overflow-visible rounded-t-[32px] flex flex-col">
            <Box className="relative">
              ...
              <Box className="absolute -top-8 -right-8 w-[70px] h-[70px] rounded-[28px] flex items-center justify-center shadow-lg z-10 border border-gray-100 bg-white">
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke={colors.primary} strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round">
            ...
            >
              ...
              <a href="#" className="font-bold text-lg block w-full pt-3 pb-1 mt-auto" style={{ color: colors.primary, background: 'none' }}>

    ...
    <>
        ...
        <Box className="max-w-7xl mx-auto px-6 lg:px-8 xl:px-0">
          <Box className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
            ...
            <Box className="flex-1 w-full">
              ...
              <Box className="space-y-4 mb-8" style={{ color: "#212121" }}>
                <p className="text-base md:text-lg leading-relaxed">
                  Our {service.title.toLowerCase()} plans are flexible and customized to your individual home needs. Regular cleaning prevents moss growth, water damage, and overflow issues that can lead to costly repairs.
                </p>
                <p className="text-base md:text-lg leading-relaxed">
                  Our <strong>biannual service (every 6 months)</strong> is the most popular choice for most homeowners. However, we recommend more frequent cleaning <strong>(every 3-4 months)</strong> for homes with high debris accumulation, those prone to moss growth, or properties located in heavy rain areas.
                </p>
              </Box>
      ...
      <Box className="bg-white py-12 md:py-16 lg:py-20">
        <Box className="max-w-5xl mx-auto px-6 lg:px-8 xl:px-0">
          ...
          <Box className="space-y-5 mb-8" style={{ color: "#212121" }}>
            <p className="text-base md:text-lg leading-relaxed">
          ...
          <Box className="mb-10" style={{ color: "#212121" }}>
            <p className="text-base md:text-lg leading-relaxed">
